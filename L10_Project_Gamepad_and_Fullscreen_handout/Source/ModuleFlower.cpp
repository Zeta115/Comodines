...
bool ModuleFlower::Start()
{
	...
	else if (App->sceneLevel_2->IsEnabled() == true)
	{
		...
		flowers[35] = CreateFlower(position.x + 288, position.y + 48, flowerTexture);
		flowers[36] = CreateFlower(position.x + 352, position.y + 48, flowerTexture);
		flowers[37] = CreateFlower(position.x + 384, position.y + 48, flowerTexture);

		flowers[38] = CreateFlower(position.x + 320, position.y + 64, flowerTexture);
		flowers[39] = CreateFlower(position.x + 368, position.y + 64, flowerTexture);
		flowers[40] = CreateFlower(position.x + 384, position.y + 64, flowerTexture);

		flowers[41] = CreateFlower(position.x + 304, position.y + 96, flowerTexture);
		flowers[42] = CreateFlower(position.x + 336, position.y + 96, flowerTexture);
		flowers[43] = CreateFlower(position.x + 384, position.y + 96, flowerTexture);
		flowers[44] = CreateFlower(position.x + 432, position.y + 96, flowerTexture);

		flowers[45] = CreateFlower(position.x + 384, position.y + 128, flowerTexture);
